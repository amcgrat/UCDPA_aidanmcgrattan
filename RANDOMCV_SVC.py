...
param_grid = {'C': [0.1,1,5,10,100], 'gamma': [1,0.5,0.1,0.01,0.001],'kernel': ['rbf', 'poly']}
...
SVC_RANDOM = RandomizedSearchCV(estimator = SVC, param_distributions = param_grid, n_iter = 18, cv = 2, verbose=2, random_state=42, n_jobs = -1,refit=True,scoring = 'accuracy')
...
SVC_pred= SVC_RANDOM.best_estimator_.predict(X_test_enc_scaled)
