...
def api_connection(n):
    ...
    #modify path
    client.download_attachments("efgi-jnkv", download_dir='C:/Users/username/Desktop/.....')
    client.close()
...
def import_data_file():
    ...
    results_sample = pd.read_csv('C:/Users/username/Desktop/CMS_DME_CLM_1.csv')
    return results_sample
...
def categorical_counts():
    ...
    #modify path if exporting file
    #uniqueValues1.to_csv('C:/Users/amcgrat/Desktop/VALUE_COUNTS.csv',index=False)
